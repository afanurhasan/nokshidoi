...
export default function ProductShowcase() {
  ...
  return (
    <section id="products" className="scroll-mt-20 py-16 sm:py-24 px-4 sm:px-6 max-w-7xl mx-auto">
      <Title
        badge="প্রতিদিনের তাজা ব্যাচ"
        title="আমাদের খাঁটি দই, মিষ্টি, রসমালাই ও মাঠার সম্ভার"
        subtitle="বগুড়ার শেরপুরের ৪টি ঐতিহ্যবাহী খাঁটি পণ্যের সমৃদ্ধ কালেকশন"
        description="বগুড়ার শেরপুরের ঐতিহ্যবাহী মাটির হাঁড়ির দই, খাঁটি ছানার মিষ্টি, রাজকীয় শাহী রসমালাই ও তাজা ঠান্ডা মাঠা — আপনার পছন্দের পণ্যটি বেছে নিয়ে সরাসরি হোয়াটসঅ্যাপে অর্ডার করুন।"
      />
